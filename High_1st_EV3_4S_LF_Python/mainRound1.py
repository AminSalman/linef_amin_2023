...
# This code is specifically adjusted for round 1
# It will only work prefectly on round 1
...
kP, kI, kD = 0.15, 0.0017, 3.3	# Set k-values for PID algorithm
...
PID_speed, turnSpeed, straightSpeed = 85, 81, 80  # PID speed, hard turns speed, and straight speed.
...
while True:
    ...
    if sensorState in [1,3,7]:	# Check if list contains current state
        ...
        wait(9)     						# Wait 9 milliseconds before repeating the loop
